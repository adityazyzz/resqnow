...
import logo from "../assets/images/resqnow.png"

const Header = ({title}) => {

  const navigation = useNavigation();

  const isHome = title === "HomePage" ? true : false;
  ...
  return (
    ...
    {title === "HomePage" && <View><Image source={logo} className = "h-7 w-32"/></View>}
    {title !== "HomePage" && <Appbar.Content title={title} titleStyle={{fontSize : 22 , color : "black"}} />}
