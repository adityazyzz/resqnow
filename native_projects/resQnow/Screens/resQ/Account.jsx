...
const Account = ({ navigation }) => {
  ...
  const [dateOfBirth, setDateOfBirth] = useState("06/03/2004");
  const [selectedBloodGroup, setSelectedBloodGroup] = useState("O+");
  const [mobile, setMobile] = useState("8877000045");
  const [savedLocation, setSavedLocation] = useState("Dwarka, New Delhi");
    ...
    <View className="bg-white h-full">
      ...
      {currentTab === false && (
        <ScrollView>
          ...
          <TextInput
            className="w-[89vw] h-7 text-black"
            style={styles.input}
          ...
          <TextInput
            className="w-[89vw] h-7 mt-1 text-black"
            style={styles.input}
            placeholder="Mobile"
            value={mobile}
            editable={editMode}
...
{/* ----------------------------------------------------  */}
      {
        ...
        <TextInput
          className="w-[89vw] text-lg pl-5 text-black"
          style={styles.input}
          value={oldPass}
          secureTextEntry
          onChangeText={(text) => {
        ...
        <TextInput
          className="w-[89vw] h-7 text-lg pl-5 text-black"
          style={styles.input}
          value={newPass1}
          secureTextEntry
          onChangeText={(text) => {
        ...
        <TextInput
          className="w-[89vw] h-7 mt-1 text-lg pl-5 text-black"
          style={styles.input}
          value={newPass2}
          secureTextEntry
          onChangeText={(text) => {
