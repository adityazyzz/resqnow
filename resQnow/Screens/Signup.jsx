...
const Signup = ({navigation}) => {
  ...
  return (
    ...
    {isKeyboardOpen === false && <Image source={logo} className="absolute top-[10vh] h-[200px] w-full"/>}
    {isKeyboardOpen === false && <Text className="mt-16" style={styles.title}>Sign Up</Text>}
